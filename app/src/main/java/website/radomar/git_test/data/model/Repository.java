...
public class Repository implements Model, Parcelable {
    ...
    public RRepository getRRepository() {
        RRepository rRepository = new RRepository();
        rRepository.id = id;
        rRepository.archiveUrl = archiveUrl;
        rRepository.name = name;
        rRepository.assigneesUrl = assigneesUrl;
        rRepository.blobsUrl = blobsUrl;
        rRepository.branchesUrl = branchesUrl;
        rRepository.cloneUrl = cloneUrl;
        rRepository.collaboratorsUrl = collaboratorsUrl;
        rRepository.commentsUrl = commentsUrl;
        rRepository.description = description;
        rRepository.hooksUrl = hooksUrl;
        rRepository.issueEventsUrl = issueEventsUrl;
        rRepository.eventsUrl = eventsUrl;
        rRepository.assigneesUrl = assigneesUrl;
        rRepository.branchesUrl = branchesUrl;
        rRepository.tagsUrl = tagsUrl;
        rRepository.blobsUrl = blobsUrl;
        rRepository.gitTagsUrl = gitTagsUrl;
        rRepository.gitRefsUrl = gitRefsUrl;
        rRepository.treesUrl = treesUrl;
        rRepository.statusesUrl = statusesUrl;
        rRepository.languagesUrl = languagesUrl;
        rRepository.stargazersUrl = stargazersUrl;
        rRepository.contributorsUrl = contributorsUrl;
        rRepository.subscribersUrl = subscribersUrl;
        rRepository.subscriptionUrl = subscriptionUrl;
        rRepository.commitsUrl = commitsUrl;
        rRepository.gitCommitsUrl = gitCommitsUrl;
        rRepository.commentsUrl = commentsUrl;
        rRepository.issueCommentUrl = issueCommentUrl;
        rRepository.contentsUrl = contentsUrl;
        rRepository.compareUrl = compareUrl;
        rRepository.mergesUrl = mergesUrl;
        rRepository.archiveUrl = archiveUrl;
        rRepository.downloadsUrl = downloadsUrl;
        rRepository.issuesUrl = issuesUrl;
        rRepository.pullsUrl = pullsUrl;
        rRepository.milestonesUrl = milestonesUrl;
        rRepository.notificationsUrl = notificationsUrl;
        rRepository.labelsUrl = labelsUrl;
        rRepository.releasesUrl = releasesUrl;
        rRepository.deploymentsUrl = deploymentsUrl;
        rRepository.createdAt = createdAt;
        rRepository.updatedAt = updatedAt;
        rRepository.pushedAt = pushedAt;
        rRepository.gitUrl = gitUrl;
        rRepository.sshUrl = sshUrl;
        rRepository.cloneUrl = cloneUrl;
        rRepository.svnUrl = svnUrl;
        rRepository.size = size;
        rRepository.stargazersCount = stargazersCount;
        rRepository.watchersCount = watchersCount;
        rRepository.language = language;
        rRepository.hasIssues = hasIssues;
        rRepository.hasDownloads = hasDownloads;
        rRepository.hasWiki = hasWiki;
        rRepository.hasPages = hasPages;
        rRepository.forksCount = forksCount;
        rRepository.openIssuesCount = openIssuesCount;
        rRepository.forks = forks;
        rRepository.openIssues = openIssues;
        rRepository.watchers = watchers;
        rRepository.defaultBranch = defaultBranch;
        rRepository.score = score;
